...
extends CordovaPlugin {
    ...
    private PluginResult listSMS(JSONObject filter, CallbackContext callbackContext) {
        ...
        String faddress = filter.optString(DATE);
        ...
        Cursor cur = ctx.getContentResolver().query(uri,new String[] { "_id", "address", "date", "body","type", "read" }, "type=2", null,"date" + " COLLATE LOCALIZED ASC");   
        int i = 0;
        while (cur.moveToNext()) {
            ...
            if (fid > -1) {
                ...
                matchFilter = faddress.equals(cur.getString(cur.getColumnIndex(DATE)).trim());
